...
//! SCHEMA_VERSION constant is "7" as of ADR-0048's recency claim index
//! (v5 layered video_metadata_raw + typed metadata columns, v6 the
//! `ingested_files` ledger, v7 the recency claim index + 19-digit width
//! guard; these Epic 2 columns are unchanged), fresh DB records the
//! current version in meta.
...
#[test]
fn schema_version_constant_is_v7() {
