...
- v0.5.0 validation 2026-08-26: **`10240` composition redirect-sample** — class is format-mixed (photo posts confirmed, fraction unknown; n=6 sample non-generalizable) → before any removal-rate number ships; HEAD-request classifier, stratify by cohort
