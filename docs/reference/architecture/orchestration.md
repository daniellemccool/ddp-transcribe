...
Since Epic 4a, `main`'s `Process` arm wraps the orchestrator in a durable batch lifecycle ([ADR 0036](../../decisions/0036-in-batch-capped-retry-with-end-of-queue-claim-ordering-fetcher-is-the-liveness-oracle.md)):
