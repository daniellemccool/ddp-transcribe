...
Onboarding reference for the ddp-transcribe pipeline (formerly `uu-tiktok`; see [ADR 0031](../../decisions/0031-rename-uu-tiktok-to-ddp-transcribe-surface-level-generalization-for-multi-study-reuse.md)). Start here.
